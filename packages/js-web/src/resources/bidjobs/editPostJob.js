...
import { Edit, FlexForm, TextInput, required, translate, BooleanInput, EditorInput, DateTimeInput, NumberInput } from 'bwork-libs';
    ...
    return (
      <Edit {...props} PostJob>
        ...
        <Grid middle container spacing={2}>
            ...
            <Grid middle item xs={12} sm={6}>
              <BooleanInput source="employerAgreed" label="Employer agreed to contract" disabled/>
            </Grid>
